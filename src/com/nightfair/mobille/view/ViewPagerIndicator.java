...
public class ViewPagerIndicator extends LinearLayout
{
	 ...
	 * 标题正常时的颜色
	 */
	private static final int COLOR_TEXT_NORMAL = 0xff9e9e9f;
	/**
	 * 标题选中时的颜色
	 */
	private static final int COLOR_TEXT_HIGHLIGHTCOLOR = 0xFF0075c4;
	...
	public ViewPagerIndicator(Context context, AttributeSet attrs)
	{
		...
		mPaint.setColor(Color.parseColor("#ff0075c4"));
